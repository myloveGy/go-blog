...
func (l *Logger) WithCallersFrames() *Logger {
	minCallerDepth, maxCallerDepth := 1, 25
	var callers []string
...
func (l *Logger) DebugFormat(format string, v ...interface{}) {
...
func (l *Logger) InfoFormat(format string, v ...interface{}) {
...
func (l *Logger) WarnFormat(format string, v ...interface{}) {
...
func (l *Logger) ErrorFormat(format string, v ...interface{}) {
...
func (l *Logger) FatalFormat(format string, v ...interface{}) {
...
func (l *Logger) PanicFormat(format string, v ...interface{}) {
